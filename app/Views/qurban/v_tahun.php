                    ...
                    foreach ($tahun as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                <?= $value['tahun_h'] ?> H /
                                <?= $value['tahun_m'] ?> M
                                <?= date('Y') == $value['tahun_m'] ? '<span class="right badge badge-success">Active</span>' : '' ?>
                            </td>
                            <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="1445" value="1445" class="form-control" name="tahun_h" required></input>
                </div>
                <div class="form-group">
                    <label>Tahun Masehi</label>
                    <input type="number" min="2024" value="2024" class="form-control" name="tahun_m" required></input>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Tahun Masehi</label>
                        <input type="number" min="2024" value="<?= $value['tahun_m'] ?>" class="form-control" name="tahun_m"
                            required></input>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
