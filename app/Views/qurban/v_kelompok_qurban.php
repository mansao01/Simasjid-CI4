                                ...
                                <table class="table table-borderless">
                                    ...
                                    foreach ($peserta as $key => $peserta) {
                                        ...
                                        <tr>
                                            ...
                                            <td>Rp.
                                                <?= number_format($peserta['biaya'], 0) ?>
                                            </td>
                                            <td>
                                                <a href="<?= base_url('PesertaQurban/DeletePeserta/' . $value['id_tahun'] . '/' . $peserta['id_peserta']) ?>"
                                    ...
                                    <tr class="text-primary">
                                        ...
                                        <td><b>Rp.
                                                <?= $peserta == null ? '0' : number_format($biaya['biaya'], 0) ?>
                                            </b>
                                        </td>
                                    </tr>
                                </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambah Kelompok
                </h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="nama_kelompok" required></input>
                </div>
            </div>
...
<?php foreach ($kelompok as $key => $value) { ?>
    ...
    <div class="modal fade" id="tambah-peserta<?= $value['id_kelompok'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Tambah Peserta
                        <?= $value['nama_kelompok'] ?>
                    </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="nama_peserta" required></input>
                    </div>
                    <div class="form-group">
                        <label>Biaya</label>
                        <input value="0" min="0" type="number" class="form-control" name="biaya" required></input>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
